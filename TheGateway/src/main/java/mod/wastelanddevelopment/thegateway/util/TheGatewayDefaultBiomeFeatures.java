...
public class TheGatewayDefaultBiomeFeatures {
    ...
    public static void addStoneVariants(Biome biomeIn) {
        ...
        biomeIn.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, RegistryFeatures.ORE.get().withConfiguration(new TheGatewayOreFeatureConfig(TheGatewayOreFeatureConfig.FillerBlockType.THE_GATEWAY_STONE, Blocks.STONE.getDefaultState(), 66)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(10, 0, 0, 80))));
    }
}
