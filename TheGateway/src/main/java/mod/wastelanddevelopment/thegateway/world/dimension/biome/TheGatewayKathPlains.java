...
public final class TheGatewayKathPlains extends Biome {
    public static final SurfaceBuilderConfig GRASS_DIRT_DIRT_CONFIG = new SurfaceBuilderConfig(RegistryBlocks.KATH_GRASS_BLOCK.get().getDefaultState(), RegistryBlocks.KATH_DIRT_BLOCK.get().getDefaultState(), RegistryBlocks.KATH_DIRT_BLOCK.get().getDefaultState());
