package mod.wastelanddevelopment.thegateway.world.dimension.chunk_generators;
...
public class ChunkGeneratorTheGateway extends NoiseChunkGenerator<GenSettingsTheGateway> {
    ...
    public ChunkGeneratorTheGateway(IWorld worldIn, BiomeProvider provider, GenSettingsTheGateway settingsIn) {
